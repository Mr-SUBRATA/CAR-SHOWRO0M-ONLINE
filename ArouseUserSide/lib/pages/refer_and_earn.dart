...
import 'package:arouse_ecommerce_frontend/api/refer_and_earn_api.dart';
...
class _ReferAndEarnState extends State<ReferAndEarn> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CAppbar(screenName: "Refer & Earn"),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                  if (loyaltyCard != null)
                    _loyaltyCard(
                      ...
                      expiry: loyaltyCard!["validTill"] != null
                          ? DateTime.parse(
                              loyaltyCard!["validTill"],
            ...
            _inputField(label: "Contact Number", controller: contactController),
            _inputField(
            ...
            SizedBox(
              ...
              child: OutlinedButton(
                ...
                style: OutlinedButton.styleFrom(
                  side: const BorderSide(color: Color(0xFF004C90), width: 1.3),
                ...
                GestureDetector(
                  onTap: () async {
                    if (pointsHistory.isEmpty) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text("No card history to export."),
                        ),
                      );
                      return;
                    }
                      ...
                      TextButton(
                        onPressed: () {
                          if (loyaltyCard != null &&
                            ...
                            // Show share options
                            // Share.share(
                            //   "Join Arouse Automotive using my referral code: $referralCode",
                            // );
                          } else {
                            // Show pay dialog
                            payAndEarnDialog(context);
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              onPressed: () async {
                                await ReferAndEarnApi.createFakeLoyaltyCard();
                                Navigator.pop(context);
                              },
