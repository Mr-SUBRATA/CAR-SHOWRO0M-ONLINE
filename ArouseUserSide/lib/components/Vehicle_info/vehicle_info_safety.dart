...
class VehicleInfoSafety extends StatefulWidget {
  final int selectedTab;
  final Map carData;

  const VehicleInfoSafety({
    super.key,
  ...
  @override
  State<VehicleInfoSafety> createState() => _VehicleInfoSafetyState();
}

class _VehicleInfoSafetyState extends State<VehicleInfoSafety> {
  List<dynamic> safety = [];
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 22),
            if (safety.isEmpty) Center(child: Text("No Safety Available")),
            for (var s in safety) bulletPoint(s),
            SizedBox(height: 20),
          ],
        ),
      ),
