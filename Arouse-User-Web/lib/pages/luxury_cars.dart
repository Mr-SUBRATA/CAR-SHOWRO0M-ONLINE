...
class LuxuryCars extends StatefulWidget {
  const LuxuryCars({super.key});

  @override
  State<LuxuryCars> createState() => _LuxuryCarsState();
}

class _LuxuryCarsState extends State<LuxuryCars> {
  List blogs = [];
  bool isLoading = true;
                ...
                Positioned(
                  ...
                  child: SafeArea(
                    child: Padding(
                      ...
                      child: CAppbar(selectedIndex: 4, isLuxury: true),
                    ),
                  ),
                ),
                Positioned(
                          ...
                          return Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                /// Button changes based on screen size
                                ElevatedButton(
                                  onPressed: () {
                      ...
                      featuredCars.isNotEmpty
                          ? CarouselSlider(
                              ...
                              items: featuredCars
                                  .map(
                                    (c) =>
                                        FeaturedCarCard(car: c, isLuxury: true),
                                  )
                                  .toList(),
                            )
      ...
      children: [
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              backgroundColor: Color.fromARGB(255, 63, 65, 84),
  ...
  return MouseRegion(
    ...
    child: GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border.all(color: const Color(0xFFFFFFFF), width: 1.15),
          borderRadius: BorderRadius.circular(18),
        ),
